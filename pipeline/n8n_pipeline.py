...
class Pipeline:
    def __init__(self):
        ...
        self.api_url = "https://host.docker.internal:5678/webhook/myflow"     # Set correct hostname
        self.api_key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZTdkMzk2YS1iMTM4LTQ3NjAtYjBmMC1iMTJiM2ViMTY4ZDkiLCJpc3MiOiJuOG4iLCJhdWQiOiJwdWJsaWMtYXBpIiwiaWF0IjoxNzQ0NDUyMjMyLCJleHAiOjE3NDcwMjI0MDB9.gHtmkk7B7-Q1k5AAc07pd2zdfSDnv77oDaCaSUknfCs"                                    # Insert your actual API key here
